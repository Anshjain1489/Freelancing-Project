export const ENDPOINTS = {
  ...
  ADMIN: {
    ...
    DELIVERY_DASHBOARD: '/admin/delivery/dashboard',
    ...
    FAILED_DELIVERY_ORDERS: '/admin/deliveries/failed',
    ...
    REASSIGN_FAILED_DELIVERY: (orderId) => `/admin/deliveries/${orderId}/reassign`,
    RETRY_FAILED_DELIVERY: (orderId) => `/admin/deliveries/${orderId}/retry`,
    RETURN_ORDER_TO_STORE: (orderId) => `/admin/deliveries/${orderId}/return-to-store`,
    CANCEL_AFTER_FAILURE: (orderId) => `/admin/deliveries/${orderId}/cancel-after-failure`,
    RESEND_WHATSAPP_DELIVERY: (orderId) => `/admin/deliveries/${orderId}/whatsapp/resend`,
    WHATSAPP_LINK: (orderId) => `/admin/deliveries/${orderId}/whatsapp-link`,
